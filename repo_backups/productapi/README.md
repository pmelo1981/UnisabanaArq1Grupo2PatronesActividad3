...
**Acceso en vivo:** http://productapi-mpn.centralus.cloudapp.azurecrmpn.azurecrmpn.cloudapp.azure.com/api/products
...
**Base URL (FQDN permanente):**
```
http://productapi-mpn.centralus.cloudapp.azurecrmpn.azurecrmpn.cloudapp.azure.com
```
...
**Health check:**
```bash
curl http://productapi-mpn.centralus.cloudapp.azurecrmpn.azurecrmpn.cloudapp.azurecom/api/products/health
```

**Listar todos los productos:**
```bash
curl http://productapi-mpn.centralus.cloudapp.azurecrmpn.azurecrmpn.cloudapp.azurecom/api/products
```

**Obtener estadísticas:**
```bash
curl http://productapi-mpn.centralus.cloudapp.azurecrmpn.azurecrmpn.cloudapp.azurecom/api/products/stats
```

**Crear producto:**
```bash
curl -X POST http://productapi-mpn.centralus.cloudapp.azurecrmpn.azurecrmpn.cloudapp.azurecom/api/products \
...
**Swagger UI:**
```
http://productapi-mpn.centralus.cloudapp.azurecrmpn.azurecrmpn.cloudapp.azurecom/swagger
```
...
**No necesita Docker Desktop.** Todo se construye en runners de GitHub en la nube.
...
Actualiza helm/values-acr.yaml con nueva imagen
    ...
    ↓
    Disponible en: http://productapi-mpn.centralus.cloudapp.azurecrmpn.azurecrmpn.cloudapp.azurecom/api/...
...
Para desplegar una versión concreta edite `helm/values-acr.yaml` (campo `image.tag`) y aplique un `helm upgrade` o deje que el pipeline lo actualice automáticamente al hacer push.
...
Esto borra: AKS, ACR, Load Balancer, Storage.
